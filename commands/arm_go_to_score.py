...
class ArmGoToScore(Command):
    ...
    def initialize(self):
        ...
        self.robot.arm.elbow.pid.setSetpoint(constants.ELBOW_BALL_SCORING_POSITION)
        self.robot.arm.wrist.pid.setSetpoint(constants.WRIST_BALL_SCORING_POSITION)
        self.robot.arm.shoulder.pid.setSetpoint(constants.SHOULDER_BALL_SCORING_POSITION)
